...
public:
    ...
    bool get_unfiltered_request(long& bubble_cnt, addr_type& req_addr, Request::Type& req_type);
    bool get_filtered_request(long& bubble_cnt, addr_type& req_addr, Request::Type& req_type);
    // trace file format 2:
    // [address(hex)] [R/W]
...
public:
    ...
    bool is_full();
    bool is_empty();
    void insert(bool ready, addr_type addr);
    long retire();
    void set_ready(addr_type addr, int mask);
